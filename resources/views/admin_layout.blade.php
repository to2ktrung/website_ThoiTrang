...
<div id="wrapper">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{URL::to('/ThemSP')}}">Thêm loại sản phẩm</a>
                    <a class="collapse-item" href="{{URL::to('/XemSP')}}">Liệt kê loại sản phẩm</a>
                </div>
            </div>
        </li>
    ...
    @Yield('admin_content')
    @Yield('admin_content_add_category')
    @Yield('admin_content_view_category')
    @Yield('admin_content_edit_category')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{URL::to('admin/login')}}">Logout</a>
            </div>
        </div>
    </div>
</div>
